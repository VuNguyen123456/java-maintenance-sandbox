...
public class conversion
{
    ...
    double parseAndRoundInput(String valueAsStr) throws NumberFormatException {
        double raw = Double.parseDouble(valueAsStr.trim());
        return roundToAccuracy(raw);
    }

    double roundToAccuracy(double value) {
    ...
    double convert(String inputAsStr, Formula f) {
